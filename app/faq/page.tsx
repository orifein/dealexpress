...
const faqs = [
  ...
  },
  {
    ...
    a: "בקבוצת הפייסבוק של DEAL EXPRESS ובערוץ הטלגרם. וואטסאפ לא פעיל כרגע.",
  },
  {
    q: "מה מוצג על הכרטיס?",
    a: "בכרטיסי אמזון: מחיר סופי משוער בשקלים (≈ ₪) וחיסכון מול מחיר בארץ כשיש השוואה. ב-AliExpress ו-iHerb: מחיר פריט משוער בשקלים (מחיר ≈ ₪) והערה משלוח לישראל לפי הקופה — בלי השוואה לבארץ.",
  },
];
