...
const faqs = [
  ...
  {
    q: "מה מוצג על הכרטיס?",
    a: "מחיר סופי משוער בשקלים (≈ ₪). בכרטיסי אמזון מוצג גם חיסכון מול מחיר בארץ כשיש השוואה. ב-AliExpress ו-iHerb מוצג רק המחיר הסופי. בלי מחיר דולר או יורו על הכרטיס או בעמוד הדיל.",
  },
];
